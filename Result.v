...
Inductive result_le : result A S -> result A S -> Prop :=
  ...
  | result_le_return : forall a1 a2, 
      preorder a1 a2 -> result_le (returnR A S a1) (returnR A S a2).

Lemma result_le_refl :
  Reflexive result_le.
Proof.
  unfold Reflexive. destruct x; constructor.
  apply preorder_refl. apply preorder_refl.
Qed.
...
Proof.
  ...
  apply H3. apply H6.
  eapply preorder_trans.  apply H3. apply H8.
Qed.
...
Definition join_result (r1 r2 : result A S) : result A S :=
  ...
  | returnR _ _ a1, returnR _ _ a2 => returnR A S (join_op a1 a2)
  | _ , _ => crashed A S
  end.
...
Proof. 
  ...
  - destruct r2; simpl; constructor. simpl. apply pair_join_upperbound_left.
  - simpl. constructor.
...
Proof. 
  ...
  - destruct r2; simpl; constructor. simpl. 
    apply pair_join_upperbound_right.
  - simpl. constructor.
