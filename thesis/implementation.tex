...
\mintinline{coq}{M A -> T M A }. In other words, in order to define a valid
...
For this use case, we have ported MonadFail, MonadExcept and MonadState from
...
Fixpoint shared_ceval 
  ...
  `{M_fail : MonadFail M, 
    ...
    M_except : forall A, MonadExcept M A, 
    nat_inst : IsNat M valType boolType natType, 
    bool_inst : IsBool M valType boolType}
  (c : com) : M unit :=
  match c with
