...
The definition of the ordering on \coq{MaybeT }, shown in Listing
...
When proving the transistivity of \coq{maybeT_le }, we perform case analysis on
...
of returnM for State is \coq{fun a => fun s => (a, s) }. The injectivity of
